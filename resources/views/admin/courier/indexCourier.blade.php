		...
		<div class="col-md-12">
			<div class="card shadow">
				<div class="card-header">
					<h2 class="mb-0">Input Courier</h2>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
							<form action="/courier" method="POST">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="courier" placeholder="Name">
								</div>
								...
								@foreach($kurir as $row)
									<tr>	
										...
										<td style="padding: 1px 15px; width: 13%">
		                                  <form style="float:left;" action="courier/{{$row->id}}/edit" method="GET">
		                                    {{ csrf_field() }}
		                                  ...
		                                  <form style="float:right;" action="courier/{{$row->id}}" method="post">
		                                    {{ method_field('DELETE') }}
		                                    {{ csrf_field() }}
